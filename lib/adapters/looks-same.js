...
* @class
*
* @param {Object} [userOptions] - It can be used in strict mode that checks
*   every pixel to look the same and a tolerance mode which permits an error
*   range, this two options cannot be used togheter. Although if you pass both
*   Mugshot will set strict mode to false
